...
export const CERT_TYPES: CertType[] = [
  ...
  },
  {
    ...
    description: "National Plant Operators Registration Scheme, covering forklift (counterbalance & reach), telehandler, MEWP, excavator and dumper operations.",
    validity: "5 years",
  ...
  },
  {
    ...
    description: "Register of Approved Driver Assessors and Trainers, a professional driving assessor qualification.",
    validity: "3 years",
  ...
  },
  {
    ...
    description: "HSE approved Emergency First Aid at Work (EFAW), a 1-day course.",
    validity: "3 years",
